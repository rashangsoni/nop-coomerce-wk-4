...
public class BuildYourOwnComputerPage extends Utility {
    ...
    By radioButtonOS = By.xpath("//input[@id='product_attribute_4_9']");
    By microsoftOfficeCheckBox = By.xpath("//input[@id='product_attribute_5_12']");
    By totalCommanderCheckbox = By.xpath("//input[@id='product_attribute_5_12']");
    By price = By.xpath("//span[@id='price-value-1']");
    By addToCart = By.xpath("//div[@class='product-item']/div[2]/div[3]/div[2]/button[1]");
